...
var getData4 = function () {
    var settings = {
        ...
        "async": true,
        "crossDomain": true,
        "url": "https://myweatherappiot.herokuapp.com/api/v1/sensor/user/raj",
        "method": "GET",
        "headers": {
       ...
       // $("#jsondisp").text(myJSON[0].username);
        ...
        $.each(myJSON, function (bb) {
           ...
           // clearArray( myChart.data.labels);
            ...
            myChart4.data.labels.push("Temp " +myJSON[bb].temperature);
            myChart4.data.datasets[0].data.push(myJSON[bb].temperature);
            myChart4.data.datasets[1].data.push(myJSON[bb].humidity);
